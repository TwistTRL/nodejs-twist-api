 ...
 * @Last Modified time: 2020-09-18 10:17:22
 */
...
async function weightCalcQuerySQLExecutor(conn, binds) {
  ...
  console.log("~~SQL getting weight for volume: ", SQL_GET_WEIGHT_CALC);
...
async function medVolQuerySQLExecutor(conn, binds) {
  let timestampLable = timeLable++;
  console.log("~~SQL for med volume in volume ", SQL_GET_MED_VOL);
