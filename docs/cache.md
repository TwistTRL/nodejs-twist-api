...
-- API_CACHE_CENSUS_INFUSIONS
CREATE TABLE API_CACHE_CENSUS_INFUSIONS(
    INFUSIONS_LIST_ID VARCHAR2(50), 
    TIME_TYPE NUMBER,    
    DRUG VARCHAR2(80),
    END_UNIX NUMBER,
...
CREATE INDEX CACHE_CENSUS_INFUSIONS_LIST_ID 
ON API_CACHE_CENSUS_INFUSIONS(INFUSIONS_LIST_ID);
